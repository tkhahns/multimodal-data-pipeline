...
class LibrosaFeatureExtractor:
    ...
    def extract_spectral_contrast(self, y: np.ndarray, sr: int) -> float:
        """
        Extract mean spectral contrast from audio data.
    ...
    def extract_all_features(self, audio_path: str) -> dict:
        ...
        # Calculate single values for time series features
        ...
        return {
            ...
            "lbrs_spectral_contrast_singlevalue": spectral_contrast,
            "lbrs_rmse_singlevalue": rmse_singlevalue,
            "lbrs_tempo_singlevalue": tempo,
